...
public class TestData {
    ...
    static {
        ...
        RESUME_1.addContact(ContactType.CELLPHONE, "+7(921) 855-0482");
        ...
        RESUME_1.addContact(ContactType.HOME_PAGE, "https://gkislin.ru/");
        ...
        RESUME_2.addContact(ContactType.EMAIL, "larycolis@gmail.com");
        RESUME_2.addContact(ContactType.CELLPHONE, "+7(963) 258-6061");
        RESUME_2.addContact(ContactType.SKYPE, "larycolis");
        RESUME_2.addContact(ContactType.LINKEDIN, "https://www.linkedin.com/in/evgeniya-bogdanova-2522b3250/");
        RESUME_2.addContact(ContactType.GITHUB, "https://github.com/Larycolis");
        ...
        RESUME_2.addSection(SectionType.QUALIFICATIONS,
                new ListSection("JEE AS: Tomcat",
                        ...
                        "Родной русский, английский \"intermediate\", сербский \"elementary\""));
        ...
        RESUME_3.addContact(ContactType.EMAIL, "test data");
        RESUME_3.addContact(ContactType.CELLPHONE, "+7(963) 258-6061");
